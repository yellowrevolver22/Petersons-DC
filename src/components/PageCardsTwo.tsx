    ...
    <main className="mt-10">
      <div className="flex w-full">
        ...
        <div className="relative w-full h-[200vh]">
          ...
          {/* STICKY TEXT */}
          <div className="sticky top-0 h-[110vh] flex flex-col justify-center items-center text-white z-10 gap-2 text-2xl font-playfair">
        ...
        <div className="relative w-full h-[200vh]">
          ...
          {/* STICKY TEXT */}
          <div className="sticky top-0 h-[110vh] flex flex-col justify-center items-center text-white z-10 gap-2 text-2xl text-center font-playfair">
